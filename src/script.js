...
let camera,container,scene,renderer,overlay,startButton,createCanvasTexture,createEmissiveMap,textureLoader
let max = 30;
let min = 2.5;
let scalerMax = 4
let scalerMin = 0.5
...
function main(){
    ...
    material1.normalMap = sunNormal, material1.emissive = new THREE.Color(1, 105/255, 180/255),material1.emissiveIntensity = 1,material1.createEmissiveMap = createEmissiveMap()
